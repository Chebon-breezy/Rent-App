...
if ($pid > 0) {
    $sql = "INSERT INTO user(userId, FirstName, LastName, userPassword, userPhoneNo, mail, propertyId) VALUES ('$id','$first','$last','$password','$phone','$email','$pid')";
} else
    $sql = "INSERT INTO user(userId, FirstName, LastName, userPassword, userPhoneNo, mail, propertyId) VALUES ('$id','$first','$last','$password','$phone','$email',null)";
...
echo "<div>
    <!-- Header/Home -->
    <header class='w3-container w3-padding-32 w3-center w3-black'>
        <h2>To go back to log in page click <a href='login.html' style='color: white;'>here</a></h2>
    </header>
</div>";
?>
